<SPAN STYLE="font-size:70.0pt"><SPAN STYLE="font-family:'EB Garamond'"> delivery-or-nah</span> </span>
...
<span style="font-size:larger;">__*delivery-or-nah*__</span> is a mobile app integrated with iOS that empowers users to compare prices between popular delivery services such as Instacart, Shipt, Uber Eats, DoorDash, GrubHub, GoPuff, and more, with the actual establishment prices.
